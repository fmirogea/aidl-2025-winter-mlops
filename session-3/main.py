...
def train_single_epoch(model, train_loader, optimizer):
    ...
    for x, y in train_loader:
        ...
        acc = binary_accuracy_with_logits(y, output)
...
def train_model(config):
    ...
    train_dataset = ImageFolder(root = 'data/cars_vs_flowers/training_set', transform = data_transforms)
    train_loader = DataLoader(train_dataset, batch_size=config["batch_size"], shuffle=True)
    test_dataset = ImageFolder(root = 'data/cars_vs_flowers/test_set', transform = data_transforms)
